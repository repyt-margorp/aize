...
- Units are auto-discovered from `./plugins/**/units/*/unit.json`.
...
- Units may set `"workspace_scope": "unit"` when they need a durable unit-level workspace across launches. Legacy `"app"` remains accepted as a compatibility alias.
