...
- Restart recovery now routes active/in-progress sessions through GoalManager review first. GoalManager receives the restart system work item and decides whether to mark the goal complete, resume a worker, or create follow-up child sessions.
