...
- `python3 -m cli` remains the command entrypoint.
...
PYTHONPATH=src AIZE_ENABLE_EXTERNAL_AGENTS=false python3 -m cli --root "$tmp/state" user-input smoke root "hello from split cli"
